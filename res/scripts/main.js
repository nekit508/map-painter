...
// TODO disabled test script
if (false) {
    const modName = "map-painter"// mod name
    const shaderName = "screenspace" // shader name
    const settingsEnabledName = "name-it-enabled"
    const settingsDebugName = "name-it-debug"

    const buffer = new FrameBuffer()
    const hueShift = new Vec3(1.0, 1.0, 0.95);
